    ...
    <div className="container-custom py-8">
      ...
      {cartItems.length === 0 ? (
        <div className="bg-white dark:bg-slate-800 rounded-lg shadow p-8 text-center">
          <p className="text-xl mb-6">{t('cart.empty', 'Your cart is empty')}</p>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-white dark:bg-slate-800 rounded-lg shadow overflow-hidden">
              <table className="w-full">
                <thead className="bg-gray-50 dark:bg-slate-700">
                  <tr>
                    <th className="py-3 px-4 text-left">{t('cart.product', 'Product')}</th>
                    <th className="py-3 px-4 text-center">{t('cart.price', 'Price')}</th>
                    <th className="py-3 px-4 text-center">{t('cart.quantity', 'Quantity')}</th>
                    ...
                    <tr key={item.id}>
                      <td className="py-4 px-4">
                        <div className="flex items-center">
                          ...
                          <Link href={`/en/products/${item.id}`} className="hover:text-ocean-blue">
                            {item.title}
                          </Link>
                        </div>
                      </td>
          ...
          <div className="lg:col-span-1">
            <div className="bg-white dark:bg-slate-800 rounded-lg shadow p-6">
              <h2 className="text-xl font-semibold mb-4">{t('cart.orderSummary', 'Order Summary')}</h2>
              ...
              <div className="mt-6 text-sm text-gray-600 dark:text-gray-400">
                <p className="mb-2">
                  {t('cart.securePayment', 'Secure payment by Stripe')}
                </p>
