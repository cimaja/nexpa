        ...
        if (userData) {
          ...
          const mockOrders: Order[] = [
            ...
            },
            {
              ...
              date: new Date(Date.now() - 23 * 24 * 60 * 60 * 1000).toLocaleDateString('en-US'),
              total: 245.75,
              status: 'delivered',
              items: 3
            }
                ...
                <table className="w-full">
                  <thead>
                    <tr className="border-b border-gray-200 dark:border-slate-700">
                      <th className="py-3 px-2 text-left">{t('orders.orderNumber', 'Order Number')}</th>
                      <th className="py-3 px-2 text-left">{t('orders.date', 'Date')}</th>
                      <th className="py-3 px-2 text-left">{t('orders.status', 'Status')}</th>
                      <th className="py-3 px-2 text-left">{t('orders.items', 'Items')}</th>
