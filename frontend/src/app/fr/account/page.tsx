          ...
          <div className="bg-white dark:bg-slate-800 rounded-lg shadow p-6">
            <div className="flex items-center justify-between mb-6">
              <h2 className="text-2xl font-semibold">
                {t('account.welcome', 'Bienvenue')}, {profile.firstName}!
              </h2>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="bg-gray-50 dark:bg-slate-700 p-4 rounded-lg">
                <h3 className="font-medium mb-3">{t('account.personalInfo', 'Informations personnelles')}</h3>
                <div className="space-y-2 text-sm">
                  <p>
                    <span className="font-medium">{t('account.name', 'Nom')}:</span> {profile.firstName} {profile.lastName}
                  </p>
                  <p>
                  ...
                  <div className="pt-2">
                    ...
                    >
                      {t('account.editProfile', 'Modifier le profil')} →
                    </Link>
                  </div>
                </div>
              </div>
              ...
              {/* Recent orders */}
              <div className="bg-gray-50 dark:bg-slate-700 p-4 rounded-lg">
                <h3 className="font-medium mb-3">{t('account.recentOrders', 'Commandes récentes')}</h3>
                <div className="space-y-2 text-sm">
                  <p className="text-gray-500 dark:text-gray-400">
                    {t('account.noOrders', 'Vous n\'avez pas encore passé de commande.')}
                  </p>
                  <div className="pt-2">
                    <Link 
                      href="/fr/products"
                      className="text-ocean-blue hover:underline text-sm"
                    >
                      {t('account.startShopping', 'Commencer vos achats')} →
                    </Link>
                  </div>
                </div>
              </div>
              ...
              {/* Saved addresses */}
              <div className="bg-gray-50 dark:bg-slate-700 p-4 rounded-lg">
                <h3 className="font-medium mb-3">{t('account.savedAddresses', 'Adresses enregistrées')}</h3>
                <div className="space-y-2 text-sm">
                  <p className="text-gray-500 dark:text-gray-400">
                    {t('account.noAddresses', 'Vous n\'avez pas encore enregistré d\'adresse.')}
                  </p>
                  <div className="pt-2">
                    <Link 
                      href="/fr/account/addresses"
                      className="text-ocean-blue hover:underline text-sm"
                    >
                      {t('account.addAddress', 'Ajouter une adresse')} →
                    </Link>
                  </div>
                </div>
              </div>
              ...
              {/* Preferences */}
              <div className="bg-gray-50 dark:bg-slate-700 p-4 rounded-lg">
                <h3 className="font-medium mb-3">{t('account.preferences', 'Préférences')}</h3>
                <div className="space-y-2 text-sm">
                  <p>
                    <span className="font-medium">{t('account.language', 'Langue')}:</span> Français
                  </p>
                  <p>
                    <span className="font-medium">{t('account.currency', 'Devise')}:</span> EUR (€)
                  </p>
                  <div className="pt-2">
                    <Link 
                      href="/fr/account/preferences"
                      className="text-ocean-blue hover:underline text-sm"
                    >
                      {t('account.editPreferences', 'Modifier les préférences')} →
                    </Link>
                  </div>
                </div>
              </div>
