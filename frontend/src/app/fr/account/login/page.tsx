...
export default function LoginPage() {
  ...
  const validateForm = () => {
    const newErrors = {
      email: !form.email ? t('login.errors.email', 'L\'email est requis') : 
             !/\S+@\S+\.\S+/.test(form.email) ? t('login.errors.emailInvalid', 'Format d\'email invalide') : '',
      password: !form.password ? t('login.errors.password', 'Le mot de passe est requis') : '',
      general: ''
    };
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setErrors({
        ...errors,
        general: t('login.errors.general', 'Une erreur est survenue lors de la connexion. Veuillez réessayer.')
      });
      setLoading(false);
    }
  };
      ...
      <div className="max-w-md mx-auto bg-white dark:bg-slate-800 rounded-lg shadow p-6">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="mb-4">
            <div className="flex items-center justify-between mb-1">
              ...
              <Link href="/fr/account/forgot-password" className="text-sm text-ocean-blue hover:underline">
        ...
        <div className="mt-6 text-center">
          <p>
            ...
            <Link href="/fr/account/register" className="text-ocean-blue hover:underline">
