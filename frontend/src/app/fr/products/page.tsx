...
export default function ProductsPage() {
    ...
    const fetchProducts = async () => {
      try {
        ...
        const mockProducts = [
          ...
          {
            id: '4',
            title: 'Planche de surf Performance',
            price: 649,
            category: 'surfboards',
  ...
  return (
    <div className="container-custom py-8">
      <h1 className="text-3xl font-bold mb-8">{t('products.title', 'Produits')}</h1>
        ...
        <div className="w-full md:w-3/4">
          ...
          <div className="flex justify-between items-center mb-6">
            <p className="text-gray-600 dark:text-gray-300">
              {sortedProducts.length} {sortedProducts.length === 1 ? 'produit' : 'produits'}
            </p>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
              {sortedProducts.map(product => (
                <div key={product.id} className="bg-white dark:bg-slate-800 rounded-lg shadow overflow-hidden">
                  ...
                  <div className="p-4">
                    <Link href={`/fr/products/${product.id}`} className="text-lg font-medium hover:text-ocean-blue">
                      {product.title}
                    </Link>
