    ...
    <div className="space-y-16">
      ...
      <section className="relative h-[70vh] overflow-hidden">
        <div className="absolute inset-0">
          <Image
            ...
            alt="Surfeur à Six-Fours-les-Plages"
            fill
        ...
        <div className="relative container-custom h-full flex flex-col justify-center">
          ...
          <div className="flex flex-wrap gap-4">
            <Link href="/fr/products" className="btn btn-primary">
              {t('home.hero.shopNow')}
            </Link>
            <Link href="/fr/about" className="btn bg-white text-ocean-blue hover:bg-gray-100">
      ...
      <section className="container-custom">
        ...
        <div className="text-center mt-8">
          <Link href="/fr/products" className="btn btn-secondary">
        ...
        <div className="container-custom">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
            <div>
              ...
              <Link href="/fr/about" className="btn btn-primary">
